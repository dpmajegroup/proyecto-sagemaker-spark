...
def create_spark_session():
    spark = (
        ...
        .appName("SageMaker-ALS-Recommender-BO")
...
def als_training_job(spark, ruta_csv_path):
    """Entrena ALS implícito para una ruta."""
    ventas = (
    ...
    client_recs["id_cliente"] = "BO|" + client_recs["compania"] + "|" + client_recs["cliente"]
...
def main():
    try:
        print("Iniciando Modelado ALS (Bolivia - Modo Implícito, rank=10)...")
