...
S3_RUTA_ESTRATEGICO_EXTERNO = "s3://aje-dl-prod-us-east-2-399723489351-external-data/aje/comercial/bo/analitica_avanzada/Pedido Estrategico.csv"
...
PRODUCTOS = [523254, 522273, 524441, 524621]
...
def leer_estrategico_externo():
    ...
    key = "aje/comercial/bo/analitica_avanzada/Pedido Estrategico.csv"
